...
<head>
<meta charset="utf-8">
<title>Winchild - Edit Career</title>
	...
	<style>
		...
		.imagefit{
			background: url("Images/teacher3.jpg") no-repeat center fixed;
...
<body>
	...
	$_SESSION["id"] = $_GET["id"];
		...
		$sql = "SELECT * FROM `career` WHERE `careerID` = ".$_GET["id"].";";
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="adminCareers.php" class="breadcrumbs_link">View Careers</a>
		</li>
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Edit Career</a>
		</li>
	</ul>
         
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- Edit Career -</h1>
			<form action="editCareerHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="position1">Position: </label>
					<input type="text" name="position1" id="position1" value="<?php echo $row["position"]; ?>"><br>
				</div>
				<div class="control">
				...
				<div class="control">
					...
					<br><label for="chkPublish">Publish Career :   <input style="display: inline" type="checkbox" id="chkPublish" name="chkPublish" <?php if($row["publish"]==1){echo "checked";} ?>>
					</label>
				<div class="control"><br>
					<p align="center"><input type="submit" value="Edit Career" id="btnevent" name="btnevent"/></p>
				</div>
