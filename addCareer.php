...
<head>
<meta charset="utf-8">
<title>Winchild - New Career</title>
	...
	<style>
		...
		.imagefit{
			background: url("Images/teacher1.jpg") no-repeat center fixed;
...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Share Careers</a>
		</li>
	</ul>
         
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- New Career -</h1>
			<form action="addCareerHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="name">Position: </label>
					<input type="text" name="position" id="position" placeholder="Enter Career Position.."><br>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="desc1">Description: </label><br><br>
					<textarea name="desc" id="desc" placeholder="Enter Career Description.."></textarea>
				</div>
				<div class="control">
				...
				<div class="control">
					...
					<br><label for="chkPublish">Publish Career :   <input style="display: inline" type="checkbox" id="chkPublish" name="chkPublish">
					</label>
				<div class="control"><br>
					<p align="center"><input type="submit" value="Add Career" id="btnevent" name="btnevent"></p>
				</div>
			</form>
		</div>
	</section>
