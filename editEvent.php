...
<head>
<meta charset="utf-8">
<title>Winchild - Edit Event</title>
	...
	<style>
		...
		.imagefit{
			background: url("Images/edit1.jpg") no-repeat center fixed;
...
<body>
	...
	$_SESSION["id"] = $_GET["id"];
		...
		$sql = "SELECT * FROM `announcement` WHERE `announcementID` = ".$_GET["id"].";";
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="adminUpcomingEvents.php" class="breadcrumbs_link">View Event</a>
		</li>
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Edit Event</a>
		</li>
	</ul>
         
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- Edit Event -</h1>
			<form action="editEventHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="name">Title: </label>
					<input type="text" name="title1" id="title1" value="<?php echo $row["title"]; ?>"><br>
				</div>
				<div class="control">
				...
				<div class="control">
					...
					<br><label for="chkPublish">Publish the Event :   <input style="display: inline" type="checkbox" id="chkPublish" name="chkPublish" <?php if($row["publish"]==1){echo "checked";} ?>>
					</label>
				<div class="control"><br>
					<p align="center"><input type="submit" value="Edit Event" id="btnevent" name="btnevent"/></p>
				</div>
