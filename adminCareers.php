...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">View Careers</a>
		</li>
	</ul>
	...
	?>
	  ...
	  <div class="column">
		<div class="card">
		  ...
		  <div class="container">
			<h2><?php echo $row["position"]?></h2><br>        
			<p><?php echo $row["description"]?></p><br>
			<p>Published by : <?php echo $row["email"]?> </p>  
			<p>Date : <?php echo $row["date"]?> </p> <br>
			<p align="center">
				<a href="editCareer.php?id=<?php echo $row["careerID"]; ?>">Edit</a>
				&nbsp;|&nbsp;
				<a href="deleteCareer.php?id=<?php echo $row["careerID"]; ?>">Delete</a>
			</p><br>
		  </div>
		</div>
		</div>
