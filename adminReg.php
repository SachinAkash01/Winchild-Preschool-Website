...
<head>
<meta charset="utf-8">
<title>Winchild - Admin Register</title>
...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Admin Register</a>
		</li>
	</ul>
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- New Admin -</h1>
			<form action="adminRegHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="name">Email: </label>
					<input type="text" name="email" id="email" placeholder="Enter Email.."><br>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="pword">Password: </label>
					<input type="password" name="pword" id="pword" placeholder="Create a Password.."><br>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="fname">Full Name: </label><br><br>
					<input type="text" name="fname" id="fname" placeholder="Enter Full Name.."><br>
				</div>
				<div class="control">
					<br><label style="font-size: 18px" for="phone">Telephone: </label>
					<input type="text" name="phone" id="phone" placeholder="Enter Telephone..">
				</div>
				<div class="control">
				...
				<div class="control"><br>
					<p align="center"><input type="submit" value="Reg Admin" id="btnevent" name="btnevent"></p>
				</div>
			</form>
		</div>
	</section>
