...
<title>Winchild - New Event</title>
	...
	<style>
		...
		.imagefit{
			background: url("Images/kids.jpg") no-repeat center fixed;
...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Add Event</a>
		</li>
	</ul>
         
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- New Event -</h1>
			<form action="addEventHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="name">Title: </label>
					<input type="text" name="title1" id="title1" placeholder="Enter Event Title.."><br>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="desc">Description: </label><br><br>
					<textarea name="desc" id="desc" placeholder="Enter Event Description.."></textarea>
				</div>
				<div class="control">
				...
				<div class="control">
					...
					<br><label for="chkPublish">Publish the Event :   <input style="display: inline" type="checkbox" id="chkPublish" name="chkPublish">
					</label>
				<div class="control"><br>
					<p align="center"><input type="submit" value="Add Event" id="btnevent" name="btnevent"></p>
				</div>
			</form>
		</div>
	</section>
