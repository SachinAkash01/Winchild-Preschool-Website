...
<head>
<meta charset="utf-8">
<title>Winchild - Student Details</title>
...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Student Details</a>
		</li>
	</ul>
	
	<h1 style="color: #323445">- Student Details -</h1>
		<table class="tblStudent" id="tblStudent">
			<tr>
				<th>Student ID</th>
				<th>Student Name</th>
				<th>DoB</th>
			...
			$sql = "SELECT studentID, studentName, DoB, age, gender, email, programName FROM student";
			...
			if (mysqli_num_rows($result) > 0)
			{
				...
				{
					echo "<tr><td>".$row["studentID"]."</td><td>".$row["studentName"]."</td><td>".$row["DoB"]."</td><td>".$row["age"]."</td><td>".$row["gender"]."</td><td>".$row["email"]."</td><td>".$row["programName"]."</td><td><a href='editStudent.php?email=".$row["email"]."'>Edit</a>|<a href='deleteStudent.php?id=".$row["studentID"]."'>Delete</a></td></tr>";
				}
				echo "</table>";
			}
			else
		...
		<h1 style="color: #323445">- Guardian Details -</h1>
		<table class="tblGuradian" id="tblGuradian">
			<tr>
				<th>Email</th>
				<th>Guradian Name</th>
				<th>Telephone</th>
			...
			<?php
			$sql1 = "SELECT email, guardianName, telephone, occupation, address FROM guardian";
			...
			if (mysqli_num_rows($result1) > 0)
			{
				...
				{
					echo "<tr><td>".$row1["email"]."</td><td>".$row1["guardianName"]."</td><td>".$row1["telephone"]."</td><td>".$row1["occupation"]."</td><td>".$row1["address"]."</td><td><a href='editStudent.php?email=".$row1["email"]."'>Edit</a>|<a href='deleteGuardian.php?email=".$row1["email"]."'>Delete</a></td></tr>";
				}
				echo "</table>";
			}
			else
