...
<body>
	...
	<nav class="navigation">
		...
		<ul>
			...
			<li><a class="active" href="#">Upcoming Events</a></li>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Upcoming Events</a>
		</li>
	</ul>
	...
	<?php
		...
		$sql = "SELECT * FROM `announcement` WHERE `publish` = '1';";
