...
<head>
<meta charset="utf-8">
<title>Winchild - Edit Activity</title>
	...
	<style>
		...
		.imagefit{
			background: url("Images/act1.jpg") no-repeat center fixed;
...
<body>
	...
	$_SESSION["id"] = $_GET["id"];
		...
		$sql = "SELECT * FROM `homework` WHERE `homeworkID` = ".$_GET["id"].";";
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="viewAdminActivities.php" class="breadcrumbs_link">View Activity</a>
		</li>
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">Edit Activity</a>
		</li>
	</ul>
         
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- Edit Activity -</h1>
			<form action="editActivityHandler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					<label style="font-size: 18px" for="title1">Title: </label>
					<input type="text" name="title1" id="title1" value="<?php echo $row["title"]; ?>"><br>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="program">Program: </label><br>
					<input type="text" name="program" id="program" value="<?php echo $row["programName"]; ?>">
				</div><br>
				<div class="control">
				...
				<div class="control"><br>
					<p align="center"><input type="submit" value="Edit Activity" id="btnactivity" name="btnactivity"/></p>
				</div>
