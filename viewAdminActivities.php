...
<head>
<meta charset="utf-8">
<title>Winchild - Activities</title>
...
<body>
	...
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs_item">
			<a href="#" class="breadcrumbs_link breadcrumbs_link--active">View Activities/Homework</a>
		</li>
	</ul>
	...
	?>
	  ...
	  <div class="column">
		<div class="card">
		  ...
		  <div class="container">
			<h2><?php echo $row["title"]?>&nbsp|&nbsp<?php echo $row["programName"] ?></h2><br>        
			<p><?php echo $row["description"]?></p><br>
			<p>Published by : <?php echo $row["email"]?> </p>  
			<p>Date : <?php echo $row["date"]?> </p> <br>
			<p align="center">
				<a href="editActivity.php?id=<?php echo $row["homeworkID"]; ?>">Edit</a>
				&nbsp;|&nbsp;
				<a href="deleteActivity.php?id=<?php echo $row["homeworkID"]; ?>">Delete</a>
			</p><br>
		  </div>
		</div>
		</div>
